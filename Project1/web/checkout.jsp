            ...
            <div class="container">
                <div class="row new-account-login">
                    ...
                    <!--                    <div class="col-sm-6 col-lg-6 mb-3">
                                            ...
                                            <h5><a data-toggle="collapse" href="Login.jsp" role="button" aria-expanded="false">Click here to Login</a></h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="order-box">
                                        ...
                                        <div class="d-flex">
                                            <h4>Tổng Tiền</h4>
                                            <div class="ml-auto font-weight-bold">${o.total()}</div>
                                        </div>

                                        <div class="d-flex">
                                            <h4>Thuế(10%)</h4>
                                            <div class="ml-auto font-weight-bold">${o.total()*0.1} </div>
                                        </div>
                                        <div class="d-flex">
                                            <h4>Shipping Cost</h4>
                                        ...
                                        <div class="d-flex gr-total">
                                            <h5>Tổng Tất Cả</h5>
                                            <div class="ml-auto h5">${o.total() + o.total()*0.1} </div>
                                        </div>
                                        <hr> </div>
                                </div>
